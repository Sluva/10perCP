...
public class SumOfSeries_Method_1Test {
	...
	public void test() throws InterruptedException, IOException {
		...
		fileWriter.close();
		SumOfSeries_Method_1.main(args);
		assertEquals(2046, SumOfSeries_Method_1.sum);
		args[0] = "./src/Task_3/files/test2.txt";
		fileWriter = new FileWriter(args[0]);
		fileWriter.write(5 + " " + 5);
		fileWriter.close();
		SumOfSeries_Method_1.main(args);
		assertEquals(94, SumOfSeries_Method_1.sum);
		args[0] = "./src/Task_3/files/test3.txt";
		fileWriter = new FileWriter(args[0]);
		fileWriter.write(15 + " " + 5);
		fileWriter.close();
		SumOfSeries_Method_1.main(args);
		assertEquals(98302, SumOfSeries_Method_1.sum);
		...
		fileWriter.close();
		SumOfSeries_Method_1.main(args);
		assertEquals(2097150, SumOfSeries_Method_1.sum);
	}
}
